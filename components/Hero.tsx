    ...
    <div className="h-[700px] w-full bg-blue-500 max-lg:h-[900px] max-md:h-[750px]">
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          ...
          "THE PRODUCT OF THE FUTURE – Where innovation meets possibility. Cutting-edge technology designed to transform the way you live, work, and connect. Experience the future today with breakthrough performance, seamless integration, and intelligent design. Elevate your world with the power of tomorrow, built for today. The future is now!"
          </p>
